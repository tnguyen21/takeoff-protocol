...
export const PROM_SLACK_FLAVOR: ContentItem[] = [
  ...
  // #research thread: Sarah Wei alignment evals → methodology discussion
  {
    ...
    channel: "#research",
    body: "{prom_scientist} — can you say more about the threshold methodology? Specifically how you're handling the capability elicitation confound. The usual concern is that if the eval itself increases capabilities, the threshold is measuring a moving target.",
  ...
  // #policy thread: David Reyes Senate contacts → timing question
  {
    ...
    channel: "#policy",
    body: "{prom_policy} — what's the realistic legislative timeline here? Last cycle it took 14 months from 'Senate staff is interested' to a markup. Do we have that kind of runway, or is this a 'write the technical input paper now' situation?",
  ...
  // #leadership thread: James Park board call → direct report response
  {
    ...
    channel: "#leadership",
    body: "{prom_ceo} — for what it's worth from the eng side: 'safety is strategy' is actually the message that's keeping senior engineers here when OB is calling. The people we most want to retain are the ones who believe it. If we need something concrete for the board, the Q3 eval results are genuinely worth showing. The interpretability coverage numbers are not something OB can match right now.",
  ...
  },
  {
    ...
    channel: "#general",
    body: "New hire orientation this morning. Seven people. All of them cited the RSP paper as the reason they chose Prometheus over OB. I thought {prom_ceo} should know that.",
  ...
  },
  {
    ...
    sender: "Darius Cole (Open Source)",
    channel: "#general",
    body: "Team dinner Friday at that Korean place on University Ave. {prom_ceo} is buying. If {prom_ceo} doesn't know this yet, he will soon.",
  ...
  },
  {
    ...
    sender: "Dr. Sarah Wei (Chief Scientist)",
    channel: "#random",
    body: "My cat knocked my laptop off the desk this morning and somehow submitted a half-finished Slack message to #safety-research that said 'what if we just.' That's it. 'What if we just.' {prom_scientist} responded 'that's the whole field.' He is not wrong.",
