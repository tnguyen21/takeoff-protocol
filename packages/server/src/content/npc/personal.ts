...
/**
 * Personal / flavor NPC triggers — granular personas per contact type.
 *
...
export const PERSONAL_NPC_TRIGGERS: NpcTrigger[] = [
...

  {
    ...
    npcId: "__npc_school__",
    content: "Reminder: Third-grade science fair projects are due Friday. Students may bring display materials on Thursday. Questions? Contact Ms. Herrera at ext. 214.",
...

  {
    ...
    npcId: "__npc_amazon__",
    content: "Your package was delivered. It's been left in the building mail room — scan the barcode on the slip to open your locker. Delivery by Amazon.",
    schedule: { round: 1, phase: "intel" },
    target: {},
  },

  {
    ...
    npcId: "__npc_doordash__",
    content: "DoorDash: Marcus picked up your Chipotle order and is on the way. 5 stops out, ETA 8:47 PM. Track: drd.sh/t/3k9xm",
    schedule: { round: 1, phase: "deliberation" },
    target: { role: "ext_nsa" },
  },
...

  {
    ...
    npcId: "__npc_drycleaner__",
    content: "Your order #3847 is ready for pickup. Please pick up by Saturday to avoid a storage fee. Hours: M-F 7am-7pm, Sat 8am-5pm. Thank you! — Martinizing Cleaners",
    schedule: { round: 2, phase: "intel" },
    target: { role: "prom_policy" },
  },
...

  {
    ...
    npcId: "__npc_fantasy__",
    content: "Your team 'Garbage Time' is 2-7 and officially eliminated from playoff contention. Better luck next year!",
...

  {
    ...
    npcId: "__npc_groupchat__",
    content: "Priya: omg who watched the UN session yesterday?? is that literally maya on tv?? / Dev: dead / Keiko: MAYA RESPOND",
    schedule: { round: 3, phase: "intel" },
    target: { role: "ext_diplomat" },
  },

  {
    ...
    npcId: "__npc_discord__",
    content: "[Phantom Wolves] bro where are you, ranked reset was yesterday, we're down a player, stop doing 'government stuff' lmao. also your energy drinks arrived, the guy left them with your neighbor again",
    schedule: { round: 1, phase: "intel" },
    target: { role: "china_intel" },
  },
...

  {
    ...
    npcId: "__npc_petco__",
    content: "Your auto-ship order for Wellness CORE RawRev has shipped! Estimated delivery: Thursday. Your cat Euler will be happy :)",
    schedule: { round: 3, phase: "intel" },
    target: { role: "prom_scientist" },
  },

  {
    ...
    npcId: "__npc_hackernews__",
    content: "Your comment on 'Ask HN: Is open-source AI regulation inevitable?' has 47 upvotes and 12 replies.",
    schedule: { round: 1, phase: "intel" },
    target: { role: "prom_opensource" },
  },

  {
    ...
    npcId: "__npc_wechat_classmates__",
    content: "[微信] 班长: 大家好，十年同学聚会开始筹备了！10月5日，有兴趣的同学报个名。人越多越好，@你 你来吗？",
    schedule: { round: 2, phase: "deliberation" },
    target: { role: "china_intel" },
  },

  {
    ...
    npcId: "__npc_comrades__",
    content: "[微信] 张华: 各位，上周末爬了趟黄山，心情不错。大家最近怎么样？有空聚一聚。@你 还是在老地方？",
    schedule: { round: 1, phase: "deliberation" },
    target: { role: "china_military" },
  },
