...
export const CHINA_SLACK_FLAVOR: ContentItem[] = [
  ...
  },
  {
    ...
    sender: "CDZ Operations (Day Shift)",
    channel: "#random",
    body: "The honor of the day shift has been thoroughly restored. 3-2 over the research team. Wei Chen's serve has improved but Liu Yang's backhand is a known quantity and we prepared accordingly. Rematch scheduled in three weeks per the standing agreement.",
