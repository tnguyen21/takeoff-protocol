...
export const CHINA_MEMO: ContentItem[] = [
    // ── Round 1 ──
    {
      ...
      sender: "DeepCent Strategic Planning",
...

    {
      ...
      sender: "CDZ Infrastructure Division",
    ...
    },
    {
      ...
      sender: "Dr. Chen Jiawei, Ecosystem Strategy Lead",
    ...
    },
    {
      ...
      sender: "Dr. Liu Yang, Senior Research Scientist",
    ...
    // ── Round 4 ──
    {
      ...
      sender: "Strategic Analysis Division",
    ...
    },
    {
      ...
      sender: "CDZ Operations Director",
