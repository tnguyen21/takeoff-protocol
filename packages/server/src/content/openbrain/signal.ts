...
export const OB_SIGNAL: ContentItem[] = [
    {
      ...
      body: "{ob_ceo} — we need to talk. The NSC is getting nervous. Some people want emergency powers to pull everything in-house. You need to be at the table before decisions get made without you.",
    ...
    },
    {
      ...
      round: 2,
      sender: "Sen. Margaret Walsh",
      body: "{ob_ceo} — I'm being briefed tomorrow. Whatever you're about to tell them — I need to hear it tonight. The language being used in the NSC right now about 'emergency authorities' is not metaphorical. If you don't get in front of this, someone else is going to make decisions about your company for you.",
    ...
    },
    {
      ...
      round: 4,
      sender: "Sen. Margaret Walsh",
      body: "{ob_ceo}. I've seen the intelligence. I've seen {ob_safety}'s memo. I have twelve colleagues ready to introduce emergency legislation Monday if you don't come to us first. Help me help you. The window to shape this from the inside closes in 48 hours.",
    ...
    },
    {
      ...
      body: "{ob_ceo}. This is the end of the informal channel. Everything after today is official and on record. For what it's worth — I've watched you make these decisions under conditions no human being has ever faced. Whatever happens next: the weight of it is real. Good luck.",
...
export const OB_SIGNAL_CEO: ContentItem[] = [
    ...
    },
    {
      ...
      body: "{ob_ceo}. I'm calling this as a colleague. If you greenlight Agent-5 without coming to us, we invoke DPA. I don't want to do that — it ends careers and poisons the well for everyone. Give us a seat at the table and we give you the legal cover you need to keep operating. That's the deal. Yes or no.",
    ...
    },
    {
      ...
      body: "{ob_ceo} — off the record. Two board members will flip to full halt if {ob_safety} goes to the press. One told me directly. Whatever you're going to do, do it before she makes her decision. You have maybe six hours.",
...
export const OB_SIGNAL_AMBIENT: ContentItem[] = [
    // Round 1 ambient — regulatoryPressure > 45
    {
      ...
      body: "{ob_ceo} — heads up, off the record. I had drinks with a Hill staffer tonight. The AI governance bill is moving faster than anyone thought. Key provision: mandatory safety filings for training runs over $100M. They think it'll get attached to the defense authorization. Timeline: six months, maybe less. We should start preparing filings now.",
    ...
    // Round 3 ambient — whistleblowerPressure > 55
    {
      ...
      body: "{ob_ceo} — not on Slack. I need to know: if I go to the board directly, without going through you first, what happens? I'm not threatening anything. I'm asking a question and I need a real answer.",
...
export const OB_SIGNAL_CTO: ContentItem[] = [
  {
    ...
    body: "{ob_cto}! Congrats on Agent-1. Saw the technical report — the attention mechanism work is exactly what we talked about at NeurIPS two years ago. Still at Google here but keeping a close eye. If you ever need an outside perspective on your safety infrastructure, coffee's on me. No strings.",
  ...
  },
  {
    ...
    body: "Hey {ob_cto} — I'm teaching a seminar on large-scale ML systems this semester and I'd like to include OpenBrain as a case study. Any chance you'd be willing to do a 30-min remote talk? The students would go absolutely wild. Happy to work around your schedule.",
