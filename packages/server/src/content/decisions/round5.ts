    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          description:
            "The window is closing. US AI capability grows every week. If the PLA is going to act, it must be now — before a deployed superintelligent system gives the US a decisive military planning advantage. Strike while the decision calculus is still conventional.",
          effects: [
