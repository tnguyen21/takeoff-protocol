      ...
      options: [
        ...
        },
        {
          ...
          effects: [
            ...
            { variable: "obBoardConfidence", delta: 7 },
            { variable: "obMorale", delta: -6 },
      ...
      options: [
        {
          ...
          effects: [
            ...
            { variable: "globalMediaCycle", delta: -6 },
            { variable: "doomClockDistance", delta: 7 },
          ],
        },
        {
    ...
    // ── China: Endgame Posture ──
    {
      ...
      options: [
        ...
        },
        {
          ...
          effects: [
            { variable: "taiwanTension", delta: 14 },
            { variable: "intlCooperation", delta: -11 },
            { variable: "economicDisruption", delta: 6 },
