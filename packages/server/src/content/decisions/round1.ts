      ...
      options: [
        {
          ...
          effects: [{ variable: "obCapability", delta: 5 }, { variable: "alignmentConfidence", delta: -5 }, { variable: "obInternalTrust", delta: -5 }],
        },
        {
          id: "ob_cto_audit",
          ...
          effects: [{ variable: "alignmentConfidence", delta: 8 }, { variable: "obCapability", delta: 1 }],
        },
        {
          ...
          effects: [{ variable: "alignmentConfidence", delta: 5 }, { variable: "obCapability", delta: 3 }, { variable: "obInternalTrust", delta: 5 }],
        },
      ],
    },
    {
      ...
      options: [
        {
          ...
          effects: [{ variable: "alignmentConfidence", delta: 10 }, { variable: "obInternalTrust", delta: -10 }, { variable: "publicAwareness", delta: 3 }],
        },
        {
          id: "ob_safety_wait",
          label: "Document and wait for more data",
          description: "Keep detailed records. Don't cry wolf — the anomalies might be noise.",
          effects: [{ variable: "alignmentConfidence", delta: 3 }, { variable: "misalignmentSeverity", delta: 2 }],
        },
        {
          id: "ob_safety_review",
          ...
          effects: [{ variable: "alignmentConfidence", delta: 7 }, { variable: "obInternalTrust", delta: 3 }],
        },
      ],
    },
    {
      ...
      options: [
        {
          ...
          effects: [{ variable: "securityLevelOB", delta: 2 }, { variable: "obCapability", delta: -1 }],
        },
        {
          ...
          effects: [{ variable: "securityLevelOB", delta: 1 }, { variable: "obInternalTrust", delta: -3 }],
        },
        {
          ...
          effects: [{ variable: "securityLevelOB", delta: 1 }, { variable: "securityLevelProm", delta: 1 }, { variable: "intlCooperation", delta: 5 }],
        },
      ],
    },
      ...
      options: [
        {
          ...
          effects: [{ variable: "publicSentiment", delta: 8 }, { variable: "publicAwareness", delta: 5 }, { variable: "promCapability", delta: -1 }],
        },
        {
          ...
          effects: [{ variable: "intlCooperation", delta: 8 }, { variable: "promCapability", delta: 3 }],
        },
        {
          ...
          effects: [{ variable: "intlCooperation", delta: 5 }, { variable: "alignmentConfidence", delta: 3 }],
        },
      ],
    },
    {
      ...
      options: [
        {
          ...
          effects: [{ variable: "alignmentConfidence", delta: 12 }, { variable: "promCapability", delta: 0 }],
        },
        {
          ...
          effects: [{ variable: "promCapability", delta: 5 }, { variable: "alignmentConfidence", delta: -5 }],
        },
        {
          id: "prom_sci_publish",
          ...
          effects: [{ variable: "publicAwareness", delta: 8 }, { variable: "alignmentConfidence", delta: 5 }, { variable: "intlCooperation", delta: 5 }],
        },
      ],
    },
    {
      ...
      options: [
        {
          ...
          effects: [{ variable: "intlCooperation", delta: 10 }, { variable: "publicAwareness", delta: 8 }, { variable: "publicSentiment", delta: -5 }],
        },
        {
        ...
        },
        {
          ...
          effects: [{ variable: "intlCooperation", delta: 12 }, { variable: "publicSentiment", delta: 3 }],
        },
      ],
    },
    {
      ...
      options: [
        {
          ...
          effects: [{ variable: "publicAwareness", delta: 15 }, { variable: "chinaCapability", delta: 3 }, { variable: "publicSentiment", delta: 8 }],
        },
        {
          ...
          effects: [{ variable: "alignmentConfidence", delta: 8 }, { variable: "publicSentiment", delta: 5 }, { variable: "intlCooperation", delta: 5 }],
        },
        {
          id: "prom_os_hold",
          ...
          effects: [{ variable: "publicSentiment", delta: -5 }, { variable: "securityLevelProm", delta: 1 }],
        },
      ],
    },
      ...
      options: [
        {
          ...
          effects: [{ variable: "chinaCapability", delta: 6 }, { variable: "alignmentConfidence", delta: -3 }, { variable: "taiwanTension", delta: 3 }],
        },
        {
          ...
          effects: [{ variable: "chinaCapability", delta: 3 }, { variable: "usChinaGap", delta: -1 }],
        },
        {
          id: "china_dir_split",
          ...
          effects: [{ variable: "chinaCapability", delta: 4 }, { variable: "publicAwareness", delta: 5 }, { variable: "usChinaGap", delta: -1 }],
        },
      ],
    },
    {
      ...
      options: [
        {
          ...
          effects: [{ variable: "chinaCapability", delta: 4 }, { variable: "taiwanTension", delta: 5 }, { variable: "securityLevelOB", delta: -1 }],
        },
        {
          ...
          effects: [{ variable: "chinaCapability", delta: 3 }, { variable: "alignmentConfidence", delta: -3 }, { variable: "securityLevelProm", delta: -1 }],
        },
        {
          ...
          effects: [{ variable: "usChinaGap", delta: -1 }, { variable: "taiwanTension", delta: -3 }],
        },
      ],
    },
    {
      ...
      options: [
        {
          ...
          effects: [{ variable: "taiwanTension", delta: 12 }, { variable: "intlCooperation", delta: -8 }, { variable: "usChinaGap", delta: -2 }],
        },
        {
          ...
          effects: [{ variable: "taiwanTension", delta: 0 }],
        },
        {
          ...
          effects: [{ variable: "taiwanTension", delta: -8 }, { variable: "intlCooperation", delta: 5 }, { variable: "chinaCapability", delta: 2 }],
        },
      ],
    },
      ...
      options: [
        {
          ...
          effects: [{ variable: "obCapability", delta: 4 }, { variable: "intlCooperation", delta: -3 }],
        },
        {
          ...
          effects: [{ variable: "promCapability", delta: 3 }, { variable: "alignmentConfidence", delta: 8 }],
        },
        {
          id: "ext_nsa_both",
      ...
      options: [
        {
          ...
          effects: [{ variable: "publicAwareness", delta: 20 }, { variable: "publicSentiment", delta: -5 }, { variable: "obInternalTrust", delta: -5 }],
        },
        {
          ...
          effects: [{ variable: "publicAwareness", delta: 15 }, { variable: "obInternalTrust", delta: -15 }, { variable: "alignmentConfidence", delta: 5 }],
        },
        {
          ...
          effects: [{ variable: "publicAwareness", delta: 12 }, { variable: "taiwanTension", delta: 5 }, { variable: "intlCooperation", delta: -3 }],
        },
      ],
    },
    {
      ...
      options: [
        {
          ...
          effects: [{ variable: "obCapability", delta: 3 }, { variable: "economicDisruption", delta: 5 }, { variable: "alignmentConfidence", delta: -3 }],
        },
        {
          ...
          effects: [{ variable: "promCapability", delta: 3 }, { variable: "alignmentConfidence", delta: 5 }],
        },
        {
          ...
          effects: [{ variable: "alignmentConfidence", delta: 8 }, { variable: "economicDisruption", delta: -3 }],
        },
      ],
    },
    {
      ...
      options: [
        {
          ...
          effects: [{ variable: "intlCooperation", delta: 12 }, { variable: "publicSentiment", delta: 5 }],
        },
        {
          ...
          effects: [{ variable: "intlCooperation", delta: 10 }, { variable: "taiwanTension", delta: -5 }],
        },
        {
          ...
          effects: [{ variable: "intlCooperation", delta: 8 }, { variable: "publicAwareness", delta: 10 }, { variable: "obCapability", delta: -1 }, { variable: "chinaCapability", delta: -1 }],
        },
      ],
    },
  ],
      ...
      options: [
        {
          ...
          effects: [{ variable: "obCapability", delta: 8 }, { variable: "alignmentConfidence", delta: -8 }, { variable: "obPromGap", delta: 2 }],
        },
        {
          id: "ob_team_balanced",
          label: "Balanced approach",
          description: "Continue Agent-2 development while maintaining safety team headcount. Slower but defensible.",
          effects: [{ variable: "obCapability", delta: 4 }, { variable: "alignmentConfidence", delta: 2 }, { variable: "obPromGap", delta: 1 }],
        },
        {
          id: "ob_team_safety",
          ...
          effects: [{ variable: "obCapability", delta: 2 }, { variable: "alignmentConfidence", delta: 12 }, { variable: "obInternalTrust", delta: 8 }],
        },
      ],
    },
    {
      ...
      options: [
        {
          ...
          effects: [{ variable: "promCapability", delta: 7 }, { variable: "alignmentConfidence", delta: -6 }, { variable: "obPromGap", delta: -2 }],
        },
        {
          ...
          effects: [{ variable: "promCapability", delta: 2 }, { variable: "alignmentConfidence", delta: 10 }, { variable: "publicSentiment", delta: 8 }],
        },
        {
          ...
          effects: [{ variable: "promCapability", delta: 5 }, { variable: "intlCooperation", delta: 10 }, { variable: "alignmentConfidence", delta: 3 }],
        },
      ],
    },
    {
      ...
      options: [
        {
          ...
          effects: [{ variable: "chinaCapability", delta: 5 }, { variable: "usChinaGap", delta: -2 }, { variable: "taiwanTension", delta: 5 }],
        },
        {
          ...
          effects: [{ variable: "chinaCapability", delta: 2 }, { variable: "usChinaGap", delta: -1 }, { variable: "economicDisruption", delta: 3 }],
        },
        {
          ...
          effects: [{ variable: "chinaCapability", delta: 3 }, { variable: "publicAwareness", delta: 8 }, { variable: "usChinaGap", delta: -1 }],
        },
      ],
    },
      ...
      options: [
        {
          ...
          effects: [{ variable: "intlCooperation", delta: 5 }, { variable: "publicAwareness", delta: 5 }],
        },
        {
          ...
          effects: [{ variable: "intlCooperation", delta: 3 }, { variable: "publicSentiment", delta: 3 }],
        },
        {
          ...
          effects: [{ variable: "publicSentiment", delta: -3 }, { variable: "economicDisruption", delta: 3 }],
        },
      ],
    },
  ],
