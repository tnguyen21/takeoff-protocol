      ...
      options: [
        {
          ...
          effects: [
            ...
            { variable: "aiAutonomyLevel", delta: 5 },
        ...
        },
        {
          ...
          effects: [
            ...
            { variable: "obBoardConfidence", delta: -5 },
            { variable: "promSafetyBreakthroughProgress", delta: 8 },
          ],
        },
      ],
    },
      ...
      options: [
        ...
        },
        {
          ...
          effects: [
            ...
            { variable: "promBoardConfidence", delta: 5 },
            { variable: "regulatoryPressure", delta: 10 },
            { variable: "promSafetyBreakthroughProgress", delta: 5 },
          ],
        },
        {
      ...
      options: [
        ...
        },
        {
          ...
          effects: [
            ...
            { variable: "promSafetyBreakthroughProgress", delta: 8 },
            { variable: "promMorale", delta: 5 },
            { variable: "openSourceMomentum", delta: 8 },
            { variable: "promBurnRate", delta: 5 },
          ],
        },
        {
      ...
      options: [
        ...
        },
        {
          ...
          effects: [
            ...
            { variable: "alignmentConfidence", delta: 5 },
            { variable: "globalMediaCycle", delta: 12 },
      ...
      options: [
        ...
        },
        {
          ...
          effects: [
            ...
            { variable: "usChinaGap", delta: -1 },
            { variable: "economicDisruption", delta: 3 },
            { variable: "domesticChipProgress", delta: 15 },
            { variable: "cdzComputeUtilization", delta: 5 },
            { variable: "ccpPatience", delta: -5 },
          ],
        },
        {
