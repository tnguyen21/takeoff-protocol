...
OpenBrain has just finished training Agent-1 — a powerful coding and research agent that's giving them a 50% internal R&D speedup. They haven't released it publicly. Their culture is velocity: ship fast, figure out alignment later."

Prometheus has a model of comparable raw capability, but they've invested heavily in alignment and interpretability instead of pure speed. Their responsible scaling policy means they won't deploy until safety evals pass. Their board is starting to get restless.
